                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Edit Data Product</span>
                            </header>
                            <div class="panel-body">
                                <form method="post" role="form" action="<?php echo base_url('admin/product_managements/process_edit'); ?>" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo form_dropdown('id_brand', $brands, set_value('id_brand', isset($dataproducts['id_brand']) ? $dataproducts['id_brand'] : ''), 'class="form-control m-bot15"'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputProductName" name="product_name" placeholder="Product Name" value="<?php echo set_value('product_name', isset($dataproducts['product_name']) ? $dataproducts['product_name'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo form_dropdown('id_category', $category, set_value('id_category', isset($dataproducts['id_category']) ? $dataproducts['id_category'] : ''), 'class="form-control m-bot15"'); ?>
                                            <span class="help-inline"><?php echo form_error('id_category'); ?></span>
                                        </div>
                                    </div><!--end form-group-->
                                    
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="gambar_sebelumnya">Gambar Sebelumnya:</label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2 col-sm-2 ">Image Upload: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                ...
                                                <input type="text" class="form-control" id="inputProductPrice" maxlength="12" name="product_price" placeholder="Product Price" value="<?php echo set_value('product_price', isset($dataproducts['product_price']) ? $dataproducts['product_price'] : ''); ?>">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputProcessor" maxlength="50" name="processor" placeholder="Processor" value="<?php echo set_value('processor', isset($dataproducts['processor']) ? $dataproducts['processor'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                <input type="text" class="form-control" id="inputMemory" maxlength="50" name="memory" placeholder="Memory" value="<?php echo set_value('memory', isset($dataproducts['memory']) ? $dataproducts['memory'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputVga" maxlength="50" name="vga" placeholder="VGA" value="<?php echo set_value('vga', isset($dataproducts['vga']) ? $dataproducts['vga'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                <input type="text" class="form-control" id="inputScreen" maxlength="5" name="screen" placeholder="Screen Size" value="<?php echo set_value('screen', isset($dataproducts['screen']) ? $dataproducts['screen'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputOs" maxlength="50" name="os" placeholder="Operating System" value="<?php echo set_value('os', isset($dataproducts['os']) ? $dataproducts['os'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputStorage" maxlength="50" name="storage" placeholder="Storage" value="<?php echo set_value('storage', isset($dataproducts['storage']) ? $dataproducts['storage'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputColor" maxlength="50" name="color" placeholder="Color" value="<?php echo set_value('color', isset($dataproducts['color']) ? $dataproducts['color'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                <input type="text" class="form-control" id="inputProductStock" maxlength="4" name="product_stock" placeholder="Product Stock" value="<?php echo set_value('product_stock', isset($dataproducts['product_stock']) ? $dataproducts['product_stock'] : ''); ?>">
