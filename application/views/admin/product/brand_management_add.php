                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Add Brand</span>
                            </header>
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/brand_managements/process_add/add'); ?>" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputBrandName" name="name" placeholder="Brand Name" value="<?php echo set_value('name'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="inputDescription" name="deskripsi" placeholder="Description" ><?php echo set_value('deskripsi'); ?></textarea>
