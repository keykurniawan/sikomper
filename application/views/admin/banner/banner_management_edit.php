                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Edit Data Banner</span>
                            </header>
                            <div class="panel-body">
                                <form method="post" role="form" action="<?php echo base_url('admin/banner_managements/process_edit'); ?>" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputBannerTitle" name="title_banner" placeholder="Banner Title" value="<?php echo set_value('title_banner', isset($databanner['title_banner']) ? $databanner['title_banner'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="inputBannerDescription" maxlength="1000" name="description_banner" placeholder="Banner Description" value="<?php echo set_value('description_banner', isset($databanner['description_banner']) ? $databanner['description_banner'] : ''); ?>"><?php echo $databanner['description_banner']; ?></textarea>
