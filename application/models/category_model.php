...
class Category_model extends CI_Model {
    ...
    public function select_all(){
        $sql = "select pc.* , "
                . "(select count(p.id_product) from products_tabel p where p.id_category = pc.id_category and p.status = '1' GROUP BY pc.id_category) as total_product "
    ...
    public function add(){
        $data = array(
            ...
            ,'permalink' => url_title($this->input->post('category_name'))
        );
